...
# --- Import Modified AERNet ---
from models.aernet_network_latent import zh_net # Use the version modified for injection

# --- Import AE and SVCD Dataset Class ---
from models.ae_model import ChangeDetectionAE
from data_loader.svcd_dataset_class import SVCD_Dataset 
...
# ===================================================================
# 2. Configuration (MODIFIED FOR SVCD)
# ===================================================================
# --- Paths ---
DATASET_ROOT_PATH = os.path.expanduser('~/projects/def-bereyhia/zjxeric/data/SVCD_dataset') 
AE_WEIGHTS_PATH = "/home/zjxeric/projects/def-bereyhia/zjxeric/AERNet/weights/best_ae_svcd.pth" 
BASE_SAVE_DIR = "./results/svcd_aernet_latent"

NUM_EPOCHS = 150 # 150
BATCH_SIZE = 16
LEARNING_RATE = 1e-4
IMG_SIZE = (512, 512) # check size
IMG_CHANNELS = 3      # rgb
AE_IN_CHANNELS = 3
...
# ===================================================================
# 4. Main Training Function (MODIFIED FOR SVCD)
# ===================================================================
def main():
    ...
    MODEL_SAVE_PATH = os.path.join(SAVE_DIR, "best_aernet_latent_svcd.pth")
    LOG_CSV_PATH = os.path.join(SAVE_DIR, "log_aernet_latent_svcd.csv")
    ...
    # --- Model Initialization (uses AE channels) ---
    ...
    print("\n--- SVCD AERNet Latent Feature training finished! ---") 
