...
BASE_SAVE_DIR = "./results/whu_aernet_benchmark"

NUM_EPOCHS = 150 # Match previous WHU benchmark
BATCH_SIZE = 16 
LEARNING_RATE = 1e-4
N_CLASSES = 2
IMG_SIZE = (512, 512) # Match the dataset loader's default
IMG_CHANNELS = 3     
...
def main():
    ...
    MODEL_SAVE_PATH = os.path.join(SAVE_DIR, "best_aernet_benchmark_whu.pth")
    LOG_CSV_PATH = os.path.join(SAVE_DIR, "benchmark_aernet_whu_log.csv")
    ...
    # Pass transforms only to the training dataset
    ...
    # Use 'test' split for validation as WHU-CD doesn't have a separate 'val' split
    ...
    print("\n--- WHU-CD AERNet Benchmark training finished! ---")
