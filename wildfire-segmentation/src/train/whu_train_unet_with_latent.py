...
AE_WEIGHTS_PATH = "./results/whu_autoencoder/best_ae_whu.pth" 
...
try:
    ...
    SEED = 42
SAVE_DIR = f"./results/whu_unet_latent_seed{SEED}"
MODEL_SAVE_PATH = os.path.join(SAVE_DIR, "best_unet_with_latent_whu.pth")
LOG_CSV_PATH = os.path.join(SAVE_DIR, "latent_whu_log.csv")
...
def main():
    ...
    print("\n--- WHU-CD Latent Feature training finished! ---")
