...
SAVE_DIR = f"./results/svcd_unet_benchmark_seed{SEED}" 
MODEL_SAVE_PATH = os.path.join(SAVE_DIR, "best_unet_benchmark_svcd_simple.pth")
LOG_CSV_PATH = os.path.join(SAVE_DIR, "benchmark_svcd_simple_log.csv")
...
# --- Class weight calculation has been removed for this simple baseline ---
...
def main():
    ...
    # --- Class weight calculation is no longer called ---
    ...
    print("\n--- SVCD Simplest Benchmark training finished! ---")
