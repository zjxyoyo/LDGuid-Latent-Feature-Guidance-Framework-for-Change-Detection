...
AE_WEIGHTS_PATH = "/home/zjxeric/projects/def-bereyhia/zjxeric/wildfire-segmentation/results/levir_autoencoder/best_ae_levir.pth" 
#/home/zjxeric/projects/def-bereyhia/zjxeric/wildfire-segmentation/results/levir_autoencoder/best_ae_levir.pth
BASE_SAVE_DIR = "./checkpoints/CD_LatentBIT_LEVIR_Experiment" #
# --- Hyperparameters ---
NUM_EPOCHS = 200
BATCH_SIZE = 8
LEARNING_RATE = 1e-4
...
def main():
    ...
    MODEL_SAVE_PATH = os.path.join(SAVE_DIR, "best_latent_bit_levir.pth")
    LOG_CSV_PATH = os.path.join(SAVE_DIR, "log_latent_bit_levir.csv")
