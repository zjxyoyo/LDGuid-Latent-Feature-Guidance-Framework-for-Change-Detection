...
def get_loader(data_name, img_size=256, batch_size=8, split='test',
    ...
    # Use FireDataset directly
    data_set = FireDataset(root_dir=root_dir, split=split,
...
def get_loaders(args):
    ...
    # Use FireDataset directly
    training_set = FireDataset(root_dir=root_dir, split=split,
                             img_size=args.img_size,is_train=True,
                             label_transform=label_transform)
    val_set = FireDataset(root_dir=root_dir, split=split_val,
