...
class ChangeDetectionAE(nn.Module):
    ...
    """
    def __init__(self, in_channels=3): # We'll default to 3 for datasets.
        super().__init__()
        
        # This encoder learns "change". Its input will be 3+3=6 channels.
        ...
        # This encoder processes "context". Its input will be 3 channels for dataset.
        ...
        # The decoder reconstructs a 3-channel image for dataset.
