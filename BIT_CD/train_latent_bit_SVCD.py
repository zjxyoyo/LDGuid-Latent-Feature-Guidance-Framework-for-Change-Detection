...
# ===================================================================
# --- Paths ---
DATASET_ROOT_PATH = "/home/zjxeric/projects/def-bereyhia/zjxeric/data/SVCD" 
AE_WEIGHTS_PATH = "/home/zjxeric/projects/def-bereyhia/zjxeric/wildfire-segmentation/results/svcd_autoencoder/best_ae_svcd.pth" 
#/home/zjxeric/projects/def-bereyhia/zjxeric/wildfire-segmentation/results/levir_autoencoder/best_ae_levir.pth
#/home/zjxeric/projects/def-bereyhia/zjxeric/wildfire-segmentation/results/svcd_autoencoder/best_ae_svcd.pth
#SAVE_DIR = "./checkpoints/CD_LatentBIT_SVCD_Experiment"
BASE_SAVE_DIR = "./checkpoints/CD_LatentBIT_SVCD_Experiment"
# MODEL_SAVE_PATH = os.path.join(SAVE_DIR, "best_latent_bit_svcd.pth")
# LOG_CSV_PATH = os.path.join(SAVE_DIR, "log_latent_bit_svcd.csv")
