...
try:
    ...
    # Ours 使用修改后的 BIT 定义 (支持 Latent 注入)
...
def main():
    ...
    print(f"--- Visualization Script v3 ---")
    ...
    # 修改1: 移除了 tokenizer_in_channels 和 dim 参数
    ...
    try:
        # 修改4: Ours加载也加 weights_only=False
    ...
    for i in tqdm(range(len(test_dataset))):
        try:
            ...
            if iou_base > 0.4 and delta > 0.05 and iou_ours > 0.8:
